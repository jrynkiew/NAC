...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    ImGui::SetNextWindowPos(ImVec2(main_viewport->WorkPos.x + 9, main_viewport->WorkPos.y + 569), ImGuiCond_FirstUseEver);
    ImGui::SetNextWindowSize(ImVec2(376, 273), ImGuiCond_FirstUseEver);
